                        ...
                        <div class="row align-items-center slider-animated-1">
                            <div class="col-lg-5 col-md-6">
                                <div class="hero-slider-content-2">
                                    <h4 class="animated">Bienvenido a</h4>
                                    <h2 class="animated fw-900">Colitas que</h2>
                                    <h1 class="animated fw-900 text-brand">Salvan</h1>
                        ...
                        <div class="row align-items-center slider-animated-1">
                            <div class="col-lg-5 col-md-6">
                                <div class="hero-slider-content-2">
                                    <h4 class="animated">Bienvenido a</h4>
                                    <h2 class="animated fw-900">Colitas que</h2>
                                    <h1 class="animated fw-900 text-7">Salvan</h1>
