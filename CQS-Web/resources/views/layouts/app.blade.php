                    ...
                    <div class="col-xl-6 col-lg-4">
                        <div class="text-center">
                            <div id="news-flash" class="d-inline-block">
                                <ul>
                                    <li>Adopta a una mascota <a href="shop.html">Aquí</a></li>
                                    <li>Qué mas fiel que la compañía de un cachorrito</li>
                                    <li>Dales una oportunidad<a href="shop.html"> Se lo merecen</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="header-wrap header-space-between position-relative">
                            ...
                            <div class="categori-dropdown-wrap categori-dropdown-active-large">
                                <ul>
                                    ...
                                    <li class="has-children">
                                        <a href="shop.html"><i class="surfsidemedia-font-dress"></i>Cachorritos</a>
                                        @auth
                                            ...
                                            <ul class="mega-menu d-lg-flex">
                                                    ...
                                                    <ul class="d-lg-flex">
                                                        @if(Auth::user()->utype == 'ADM')
                                                            <li class="mega-menu-col col-lg-6">
                                                                    ...
                                                                    <ul>
                                                                        <li><span class="submenu-title">Los más vistos</span></li>
                                                                        <li><a class="dropdown-item nav-link nav_item" href="#">Agregar</a></li>
                                                                        <li><a class="dropdown-item nav-link nav_item" href="#">Agregar</a></li>
                                                                        <li><a class="dropdown-item nav-link nav_item" href="#">Agregar</a></li>
                                                                    </ul>
                                                        ...
                                                        <li class="mega-menu-col col-lg-6">
                                                            <ul>
                                                                <li><span class="submenu-title">Agregar txt</span></li>
                                                                <li><a class="dropdown-item nav-link nav_item" href="#">Agregar</a></li>
                                                                <li><a class="dropdown-item nav-link nav_item" href="#">Agregar</a></li>
                                                                <li><a class="dropdown-item nav-link nav_item" href="#">Agregar</a></li>
                                                            </ul>
                                                ...
                                                <li class="mega-menu-col col-lg-5">
                                                    <div class="header-banner2">
                                                        <img src="assets/imgs/banner/menu-banner-2.png" alt="menu_banner1">
                                                    ...
                                                    <div class="header-banner2">
                                                        <img src="assets/imgs/banner/menu-banner-3.png" alt="menu_banner2">
                                                        <div class="banne_info">
                                                            <h6>Tú amigo</h6>
                                                            <h4>Fiel</h4>
                                                            <a href="#">Adopta</a>
                                    ...
                                    <li class="has-children">
                                        <a href="shop.html"><i class="surfsidemedia-font-tshirt"></i>Veteranos</a>
                                        @auth
                                        <div class="dropdown-menu">
                                            <ul class="mega-menu d-lg-flex">
                                                <li class="mega-menu-col col-lg-7">
                                                    ...
                                                    @if(Auth::user()->utype == 'ADM')
                                                        <li class="mega-menu-col col-lg-6">
                                                            <ul>
                                                                <li><span class="submenu-title">Los mas adoptados</span></li>
                                                                <li><a class="dropdown-item nav-link nav_item" href="#">Agregar</a></li>
                                                                <li><a class="dropdown-item nav-link nav_item" href="#">Agregar</a></li>
                                                                <li><a class="dropdown-item nav-link nav_item" href="#">Agregar</a></li>
                                                            </ul>
                                                    ...
                                                    @else
                                                        <li class="mega-menu-col col-lg-6">
                                                            <ul>
                                                                <li><span class="submenu-title">Poner txt</span></li>
                                                                <li><a class="dropdown-item nav-link nav_item" href="#">Agregar</a></li>
                                                                <li><a class="dropdown-item nav-link nav_item" href="#">Agregar</a></li>
                                                                <li><a class="dropdown-item nav-link nav_item" href="#">Agregar</a></li>
                                                            </ul>
                                                ...
                                                <li class="mega-menu-col col-lg-5">
                                                    <div class="header-banner2">
                                                        <img src="assets/imgs/banner/menu-banner-4.png" alt="menu_banner1">
                                                        <!-- <div class="banne_info">
                                                            <h6>10% Off</h6>
                                                            <h4>New Arrival</h4>
                                                            <a href="#">Shop now</a>
                                    ...
                                    <li class="has-children">
                                        <a href="shop.html"><i class="surfsidemedia-font-smartphone"></i> Apoyo Emocional</a>
                                        @auth
                                        <div class="dropdown-menu">
                                            <ul class="mega-menu d-lg-flex">
                                                <li class="mega-menu-col col-lg-7">
                                                    ...
                                                    @if(Auth::user()->utype == 'ADM')
                                                        <li class="mega-menu-col col-lg-6">
                                                            <ul>
                                                                <li><span class="submenu-title">Destacados</span></li>
                                                                <li><a class="dropdown-item nav-link nav_item" href="#">Agregar</a></li>
                                                                <li><a class="dropdown-item nav-link nav_item" href="#">Agregar</a></li>
                                                                <li><a class="dropdown-item nav-link nav_item" href="#">Agregar</a></li>
                                                        </li>
                                                    @else
                                                        <li class="mega-menu-col col-lg-6">
                                                            <ul>
                                                                <li><span class="submenu-title">Accessorios</span></li>
                                                                <li><a class="dropdown-item nav-link nav_item" href="#">Agregar</a></li>
                                                                <li><a class="dropdown-item nav-link nav_item" href="#">Agregar</a></li>
                                                                <li><a class="dropdown-item nav-link nav_item" href="#">Agregar</a></li>
                                                            </ul>
                                                ...
                                                <li class="mega-menu-col col-lg-5">
                                                    <div class="header-banner2">
                                                        <img src="assets/imgs/banner/menu-banner-5.png" alt="menu_banner1">
                                                        <div class="banne_info">
                                                            <!-- <h6>10% Off</h6> -->
                                                            <h4 style="color:white;">Amigo</h4>
                                                            <!-- <a href="#">Shop now</a> -->
                                                        </div>
                                                    </div>
                                                    <div class="header-banner2">
                                                        <img src="assets/imgs/banner/menu-banner-6.png" alt="menu_banner2">
                                                        <div class="banne_info">
                                                            <!-- <h6>15% Off</h6> -->
                                                            <h4 style="color:white;">Familia</h4>
                                                            <!-- <a href="#">Shop now</a> -->
                                                        </div>
                                                    </div>
                                                </li>
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                            <nav>
                                <ul>
                                    ...
                                    @auth
                                     <li><a href="{{ route('shop') }}">Mascotas</a></li>
                                    @endif
                                    ...
                                    -->
                                        ...
                                        @if(Auth::user()->utype == 'ADM')
                                            <ul class="sub-menu">
                                                ...
                                                <li><a href="{{route('admin.products')}}">Mascotas</a></li>
                                                <li><a href="{{route('admin.categories')}}">Categories</a></li>
                                                <li><a href="{{route('admin.home.slider')}}">Agregar Slider</a></li>
                    ...
                    <div class="hotline d-none d-lg-block">
                        <p><i class="fi-rs-smartphone"></i><span>Llame</span> (+52) 99-11-05-12-24 </p>
                    </div>
                        ...
                        <div class="header-action-2">
                            ...
                            <div class="header-action-icon-2">
                                <a class="mini-cart-icon" href="cart.html">
                                    <img alt="Surfside Media" src="assets/imgs/theme/icons/pata.svg">
        ...
        <div class="mobile-header-wrapper-inner">
            ...
            <div class="mobile-header-content-area">
                <div class="mobile-search search-style-3 mobile-header-border">
                    <form action="#">
                        <input type="text" placeholder="Busca tu mascota aquí...">
                ...
                <div class="mobile-menu-wrap mobile-header-border">
                    <div class="main-categori-wrap mobile-header-border">
                        <a class="categori-button-active-2" href="#">
                            <span class="fi-rs-apps"></span> Ver categories
                        </a>
                    ...
                    <div class="col-lg-7 mb-md-3 mb-lg-0">
                        <div class="row align-items-center">
                            <div class="col flex-horizontal-center">
                                ...
                                <h4 class="font-size-20 mb-0 ml-3">Envianos un correo</h4>
                            </div>
                            <div class="col my-4 my-md-0 des">
                                <h5 class="font-size-15 ml-4 mb-0">...forma parte<strong>de salvando colitas!</strong></h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5">
            ...
            <div class="container pt-15 pb-20">
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            ...
                            <p class="wow fadeIn animated">
                                <strong>Ciudad: </strong>Motul, Yuc.
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Telefono: </strong>+52 99-11-05-12-24
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Email: </strong>salvandocolitas@gmail.com
                            </p>
                    ...
                    <div  class="col-lg-2 col-md-8">
                        <h5 widget-title wow fadeIn animated">
                            <ul class="footer-list wow fadeIn animated">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d119195.70795054783!2d-89.70376289616847!3d20.99801297113545!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1sadopcion%20de%20perritos%20merida!5e0!3m2!1ses-419!2smx!4v1686092203409!5m2!1ses-419!2smx" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </ul>
                        </h5>
                    </div>
                    <!-- <div class="col-lg-2  col-md-3">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p class="text-lg-end text-start font-sm text-muted mb-0">
                        &copy; <strong class="text-brand">ColitasQueSalvan</strong> Reservados todos los derechos
                    </p>
                </div>
            </div>
        </div>
