        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span> Fashion
                    <span></span> Adopcion De Mascotas
                </div>
            </div>
        </div>
                        ...
                        <div class="product-detail accordion-detail">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <div class="social-icons single-share">
                                        <ul class="text-grey-5 d-inline-block">
                                            <li><strong class="mr-10">Redes Sociales:</strong></li>
                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="product-detail-rating">
                                            <div class="pro-details-brand">
                                                <span> Nota: <a href="shop.html">Tu mejor amigo</a></span>
                                            </div>
                                        ...
                                        <div class="clearfix product-price-cover">
                                            <div class="product-price primary-color float-left">
                                                <ins><span class="text-brand">{{$product->regular_price}} </span><span>Años</span></ins>
                                        ...
                                        <div class="detail-extralink">
                                            ...
                                            <div class="product-extra-link2">
                                                <button type="button" class="button button-add-to-cart" wire:click.prevent="store({{$product->id}},'{{$product->name}}',{{$product->regular_price}})">Adóptame</button>
                            ...
                            <div class="tab-style3">
                                <ul class="nav nav-tabs text-uppercase">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="Reviews-tab" data-bs-toggle="tab" href="#Reviews">Reseñas (3)</a>
                                    </li>
                                </ul>
                            ...
                            <div class="row mt-60">
                                <div class="col-12">
                                    <h3 class="section-title style-1 mb-30">Mascotas relacionadas</h3>
                                </div>
                                <div class="col-12">
                                            ...
                                            <div class="product-cart-wrap small hover-up">
                                                ...
                                                <div class="product-content-wrap">
                                                    ...
                                                    <div class="product-price">
                                                        <span>{{$rproduct->regular_price}} </span><span>Años</span>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            <div class="widget-header position-relative mb-20 pb-10">
                                <h5 class="widget-title mb-10">Nueva Mascota</h5>
                            ...
                            <div class="single-post clearfix">
                                ...
                                <div class="content pt-10">
                                    ...
                                    <p class="price mb-0 mt-5">{{$nproduct->regular_price}} Años</p><p></p>
