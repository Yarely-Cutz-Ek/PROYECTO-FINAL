                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <a href="{{route('admin.products')}}" class="btn btn-success float-end">Todas Las Mascotas</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <form wire:submit.prevent="updateProduct">
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <textarea type="text" name="regular_price" class="form-control" placeholder="Enter regular price" wire:model="regular_price"></textarea>
                                        @error('regular_price')
                                            <p class="text-danger">{{$message}}</p>
                                        @enderror
                                    </div>
