...
Route::get('/shop', ShopComponent::class)->name('shop')->middleware('auth')->middleware('auth');

Route::get('/product/{slug}', DetailsComponent::class)->name('product.details');

Route::get('/cart', CartComponent::class)->name('shop.cart')->middleware('auth');

Route::get('/wishlist', WishlistComponent::class)->name('shop.wishlist')->middleware('auth');

Route::get('/checkout', CheckoutComponent::class)->name('shop.checkout')->middleware('auth');
