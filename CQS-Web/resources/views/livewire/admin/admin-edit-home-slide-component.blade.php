                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <a href="{{route('admin.home.slider')}}" class="btn btn-success float-end">Todos Los Slides</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <form action="" wire:submit.prevent="updateSlide">
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        @else
                                            <img src="{{asset('assets/imgs/slider')}}/{{$image}}" width="100" alt="">
                                        @endif
                                        @error('image')
                                            <p class="text-danger">{{$message}}</p>
                                        @enderror
