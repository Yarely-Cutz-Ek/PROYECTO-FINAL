<div>
    {{-- Aquí agregamos el main de cart, la plantilla que estamos usando --}}
                    ...
                    <div class="col-12">
                            ...
                            <table class="table shopping-summery text-center clean">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="price" data-title="Price"><span>{{$item->model->regular_price}} </span><span>Años</span></td>
                                    ...
                                    <tr>
                                        <td colspan="6" class="text-end">
                                            <a href="#" class="text-muted" wire:click.prevent="clearAll()"> <i class="fi-rs-cross-small"></i> Borrar Adopciones</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="cart-action text-end">
                            <a class="btn  mr-10 mb-sm-15"><i class="fi-rs-shuffle mr-10"></i>Update Cart</a>
                             <a class="btn "><!--<i class="fi-rs-shopping-bag mr-10"></i>-->Continuar Adopción</a>
                        </div>
